...
const allowedOrigins = ["localhost", "127.0.0.1", "10.232.248.114", "10.242.218.114"];

if (isDev) {
  // Expand common 10.x subnets
  for (let i = 1; i <= 254; i++) {
    allowedOrigins.push(`10.232.248.${i}`);
    allowedOrigins.push(`10.242.218.${i}`);
  }
